 ...
 * @zeta.usage INTERNAL
 */
public abstract class BungeeCordUntypedSQLDataStorer<PrimaryKeyType> extends BungeeDataStorer implements ISQLTableHandler<PrimaryKeyType> {
    ...
    public BungeeCordUntypedSQLDataStorer(ZetaBungeePlugin instanceIn, String name, String tableName) {
