...
/**
 * This is an implementation of {@link ISQLTableHandler}. This is used for {@link BungeeDataStorer data storers} that store data in one table in a database.
 ...
 * If you just want to store data in a table, you can use {@link BungeeCordUntypedSQLDataStorer}
 *
 * @param <PrimaryKeyType> The type of the primary key of the table.
 * @author YeetManLord
 */
public abstract class BungeeCordSQLDataStorer<PrimaryKeyType> extends BungeeDataStorer implements ISQLTableHandler<PrimaryKeyType> {
    ...
    public BungeeCordSQLDataStorer(ZetaBungeePlugin instanceIn, String name, String tableName) {
